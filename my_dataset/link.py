...
root = 'nodeflux-vehicle'

link(os.path.join(root, 'mixed/train/images/'), 'train/images/')
link(os.path.join(root, 'mixed/train/annotations.json'), 'train/annotations.json')
link(os.path.join(root, 'mixed/val/images/'), 'val/images/')
link(os.path.join(root, 'mixed/val/annotations.json'), 'val/annotations.json')